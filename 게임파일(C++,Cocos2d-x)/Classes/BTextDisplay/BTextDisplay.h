...
public:
	...
	void Init(CCLayer* pThisScene,int nLayer, string stdName, float fX, float fY, int nLineWidth, int nLineHeight, CCPoint stSize, ccColor3B Color, string stdFont = "으뜸체", bool Ortho2D = true);
